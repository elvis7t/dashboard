<?php
$sess = "GRA_LOCAL";
$pag = "at_grafico_maquinas_garantia_local.php";
...
<script>
  $(function () {
    ...
    var donutData = [
        {label: 'Garantia', data: <?=$mqtotalgarlocal;?>, color:'#00c0ef'},
        {label: 'S/ Garantia', data: <?=$mqtotalsemgarlocal;?>, color:'#f23e11'} 
...
<script>  
   $(function () {
    ...
    var donut = new Morris.Donut({
      ...
      data: [
        {label: 'Na Garantia', value: <?=$mqtotalgarlocal;?>},
        {label: 'Sem Garantia', value: <?=$mqtotalsemgarlocal;?>}
      ],  
      hideHover: 'auto'
    });  
    ...
    var bar = new Morris.Bar({
      ...
      resize: true,
      data: [ 
        {y: 'Com Garantia',  a: <?=$mqtotalgarlocal ;?>},
        {y: 'Sem Garantia',  b: <?=$mqtotalsemgarlocal ;?>}
      ], 
