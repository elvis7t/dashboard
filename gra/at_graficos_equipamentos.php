<?php
$sess = "GRA";
$pag = "at_graficos_equipamentos.php";
		  ...
		  <!--DONUT CHART - Graficos de rosca com valores-->
			...
			<div class="box-footer no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="#">Total de Equipamentos
                  <span class="pull-right text-red"> <?=$equipamentos;?></span></a></li>
...
<script> 
   $(function () {
    ...
    var donut = new Morris.Donut({
      ...
      data: [
        {label: 'NIFF', value: <?=$eqniff;?>},
        {label: 'EOVG', value: <?=$eqeovg;?>},
        {label: 'VUG',  value: <?=$eqvug;?>}, 
        {label: 'LAV',  value: <?=$eqlavras;?>},
        {label: 'ARUJA',value: <?=$eqaruja;?>},
		{label: 'ABC',  value: <?=$eqabc;?>},
        {label: 'CAMP', value: <?=$eqcamp;?>},
        {label: 'RAPD', value: <?=$eqrapdo;?>}, 
        {label: 'CISNE',value: <?=$eqcisne;?>}
      ],
      hideHover: 'auto'
    });  
