...
?>
      ...
      <header class="main-header"> 
        ...
        <!-- Logo -->
        <a href="<?=$hosted;?>/view/index.php?token=<?=$_SESSION['token'];?>" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><img src="<?=$hosted."/".$_SESSION['logo'];?>" width="50"></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="<?=$hosted."/".$_SESSION['logo'];?>" width="50"></span>
        </a>
			...
			<?=$_SESSION['nome_usu'];?>
				<small><?=$_SESSION['usuario'];?></small>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?=$hosted;?>/view/sys_user_perfil.php?token=<?=$_SESSION['token'];?>&usuario=<?=$_SESSION['usu_cod'];?>" class="btn btn-default btn-flat">Perfil</a>
                    </div>
