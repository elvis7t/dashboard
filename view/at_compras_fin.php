...
session_start();
$sess = "COM";
$pag = "at_compras_fin.php";// Fazer o link brilhar quando a pag estiver ativa
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Solicita&ccedil;&atilde;oes Finalizadas</li>
			</ol>
        </section>
        <!-- Main content -->
			...
			<div class="row">
				...
				<div class="box box-primary"> 
	 				<div class="box-header with-border">
						<h3 class="box-title">Solicita&ccedil;&atilde;oes</h3><div class="box-tools pull-right">
					...
					<div class="box-body">
						<table id="manutencao" class="table table-bordered table-striped">
							...
							<tbody id="Man_cad"> 
								<?php require_once("at_tbcomprasfin.php");?>     
							</tbody> 
							 
						</table>   
					</div><!-- /.box-body --> 
					<div class="box-footer">  
				<!--<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Nova Compra' href="at_vis_compra.php?token=<?=$_SESSION['token']?>"><i class="fa fa-cart-plus"></i> Nova</a>-->
			</div>
