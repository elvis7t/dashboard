				...
				<!-- general form elements -->
					<div class="box box-success"> 
						...
						<div class="box-footer">
							<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Nova Institui&ccedil;&atilde;o' href="at_vis_Instituicoeslocais.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Nova</a>
						</div>								
					</div><!-- /.box -->				
				</div><!-- /.form -->
			</div><!-- /.row -->
