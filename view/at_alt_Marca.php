...
session_start();
$sess = "ATIVO";
$pag = "at_eqmarca.php";// Fazer o link brilhar quando a pag estiver ativa
        ...
        <section class="content">
			<?php
				$menu = array(
							...
							"N" => array("class" => "btn btn-warning btn-sm", "icone" => "fa fa-refresh", "id"=>"btn_Altmarc","label"=>"Alterar") 
							);
 				extract($_GET);
 				$rs = new recordset();
			 ...
			 <div class="row">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<!-- form start --> 
						<form role="form" id="alt_marca"> 
							   
							<div class="box-body">
								<!-- radio Clientes -->
								<div id="usuarios" class="row">    
									<div class="form-group col-xs-1">
										<label for="marc_id">#ID:</label>
										<input type="text" DISABLED class="form-control" name="marc_id" id="marc_id" value="<?=$rs->fld("marc_id");?>"/>
									...
									<div class="form-group col-xs-3 ">
									 ...
									 <div class="form-group col-xs-3 ">  
										<label for="usu_nome">Marca</label>
										<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-android"></i>
										</div>
										<input type="text"  class="form-control" name="marc_nome" id="marc_nome" value="<?=$rs->fld("marc_nome");?>"/>
									</div> 
									</div> 
