			...
			<div class="row">
				...
				<div class="box box-success"> 
					<div class="box-header with-border">
						<h3 class="box-title">HDs Cadastrados</h3><div class="box-tools pull-right">
				...
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Novo' href="at_vis_Hdlocal.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Novo</a>
			</div>
