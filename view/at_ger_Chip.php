					...
					<div class="box-header with-border">
						...
						<form role="form" id="alt_chip"> 
										...
										<?php
												...
												<span class="input-group-btn">
												 	<div class="button-group"> 
														<a 	class="btn btn-sm btn-info pull-left" data-toggle='tooltip' data-placement='bottom' title='Gerenciar'  a href="at_ger_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$rs->fld('eq_id');?>"><i class="fa fa-dashboard"></i></a>
													</div> 
												  </span>
												</div>
							...
							<table id="maquinas" class="table table-bordered table-striped">
								...
								<td><a 	class="btn btn-sm btn-success" data-toggle='tooltip' data-placement='bottom' title='Alterar Equipamento'  a href="at_alt_eq_Chip.php?token=<?=$_SESSION['token']?>&acao=N&chipid=<?=$chip_id;?>"><i class="glyphicon glyphicon-phone"></i> Alterar Equipamento</a></td>
