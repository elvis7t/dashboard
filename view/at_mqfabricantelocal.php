...
session_start();
$sess = "ATIVOLOCAL";
$pag = "at_mqfabricantelocal.php";// Fazer o link brilhar quando a pag estiver ativa
			...
			<div class="row">
				...
				<div class="box box-success"> 
					<div class="box-header with-border">
						<h3 class="box-title">Fabricantes Cadastradas</h3><div class="box-tools pull-right">
					...
					<div class="box-body">
						<table id="fabricante" class="table table-bordered table-striped">
							...
							<tbody id="cad_fab">
								<?php require_once("at_tbFabricantelocal.php");?>    
							</tbody> 
							 
						</table>
					</div><!-- /.box-body --> 
					<div class="box-footer">
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Novo' href="at_vis_Fabricantelocal.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Novo</a>
			</div>
