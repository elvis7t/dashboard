				  ...
				  <!-- general form elements -->
                    <div class="box box-primary">
						<div class="box-header with-border">
						 <h3 class="box-title"> Usu&aacute;rios ativos</h3>
						...
						<!-- form start -->
						<div class="box-body">
							<table id="usuarios_ativos" class="table table-bordered table-striped">
								<thead>
									<tr>
										<th>C&oacute;d:</th>
										<th>Empresa</th>
						...
						<div class="box-footer">
							<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Novo Usuario' href="sys_vis_cadUsuarios.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Novo</a>
						</div>							
					</div><!-- /.box -->	
					
					<div class="box box-success">
						<div class="box-header with-border">
						 <h3 class="box-title">Usu&aacute;rios Desativados</h3>
							<div class="box-tools pull-right">
								<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>   
							</div>
						</div><!-- /.box-header -->
						<!-- form start -->
						<div class="box-body">
							<table id="usuarios_inativos" class="table table-bordered table-striped">
								<thead>
									<tr>
										<th>C&oacute;d:</th>
										<th>Empresa</th>
								...
								<tbody id="Mq_cad"> 
									<?php require_once("sys_tbUsuarios_inativos.php");?>
								</tbody> 							 
							</table> 
						</div><!-- /.box-body --> 
						<div class="box-footer">
