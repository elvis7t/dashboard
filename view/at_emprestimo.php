        ...
        <section class="content">
			...
			<!-- left column -->
				...
				<div class="box box-primary">
					...
					<!-- form start -->
					<div class="box-body">
						<table id="eqemprestimo" class="table table-bordered table-striped">
							<thead>
								  <tr>
										<th>C&oacute;d:</th>
										<th>Empresa</th>  
							...
							<tbody id="empre_cad"> 
								<?php require_once("at_tbEqemprestimo.php");?>      
							</tbody> 
			  ...
			  <div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title">M&aacute;quinas</h3><div class="box-tools pull-right">
		                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>   
						</div>
					</div><!-- /.box-header --> 
					<!-- form start -->
					<div class="box-body">
						<table id="mqemprestimo" class="table table-bordered table-striped">
							<thead>
								  <tr>
										<th>C&oacute;d:</th>
										<th>Empresa</th>  
							...
							<tbody id="empre_cad"> 
								<?php require_once("at_tbMqemprestimo.php");?>      
							</tbody> 
