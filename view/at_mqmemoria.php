...
session_start();
$sess = "ATIVO";
$pag = "at_mqmemoria.php";// Fazer o link brilhar quando a pag estiver ativa
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Mem&oacute;ria</li>
			</ol>
        </section>
        <!-- Main content -->
				...
				<div class="box box-success"> 
					...
					<div class="box-body">
						<table id="fabricante" class="table table-bordered table-striped">
							...
							<tbody id="cad_fab">
								<?php require_once("at_tbMemoria.php");?>    
							</tbody> 
							 
						</table>
					</div><!-- /.box-body --> 
					<div class="box-footer">
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Novo' href="at_vis_Memoria.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Nova</a>
			</div>
