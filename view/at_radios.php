			...
			<div class="row">
				...
				<div class="box box-success"> 
	 				<div class="box-header with-border">
						<h3 class="box-title">R&aacute;dios de Reserva</h3><div class="box-tools pull-right">
					...
					<div class="box-body">
						<table id="equipamentos" class="table table-bordered table-striped">
							...
							<tbody id="eq_cad"> 
								<?php require_once("at_tbRadios.php");?>     
							</tbody> 
							 
						</table>  
					</div><!-- /.box-body --> 
					<div class="box-footer"> 
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Novo Equipamento' href="at_vis_Equipamentos.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Novo</a>
			</div>
