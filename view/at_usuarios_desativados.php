...
session_start();
$sess = "ATIVO";
$pag = "at_usuarios_desativados.php";// Fazer o link brilhar quando a pag estiver ativa
			...
			<div class="row">
				...
				<div class="box box-success"> 
					<div class="box-header with-border">
						<h3 class="box-title">Usu&aacute;rios Desativados</h3><div class="box-tools pull-right">
					...
					<div class="box-body">
						<table id="usuarios" class="table table-bordered table-striped">
							...
							<tbody id="usu_cad"> 
								<?php require_once("at_tbUsuarios_desativados.php");?>     
							</tbody> 
							 
						</table>  
					</div><!-- /.box-body --> 
					<div class="box-footer"> 
				<!--<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Novo Usuário' href="at_vis_Usuarios.php?token=<?=$_SESSION['token']?>"><i class="fa fa-user-plus"></i> Novo</a>--> 
			</div>
