        ...
        <section class="content"> 
			<?php
				$menu = array(
							...
							"N" => array("class" => "btn btn-warning btn-sm", "icone" => "fa fa-recycle", "id"=>"btn_AltEq","label"=>"Alterar") 
							);
 				extract($_GET);
 				$rs = new recordset();
							...
							<div class="box-body">
								...
								<div id="" class="row">
									...
									<div class="form-group col-md-2">  
										...
										<input type="text" DISABLED class="form-control" name="solic_tickets" id="solic_ticket" value="<?=$rs->fld("solic_ticket")?>"/>  
										</div>
									</div>
									...
									<div class="form-group col-md-3">   
										...
										<input type="text" DISABLED class="form-control" name="solic_data" id="solic_data" value="<?echo $fn->data_hbr($rs->fld("solic_data"));?>"/>  
										</div> 
									</div>
									...
									<div class="form-group  col-md-6">  
										...
										<input type="text" DISABLED  class="form-control" name="solic_desc" id="solic_desc" value="<?=$solic;?>"/>  
									</div>					
									</div>	
