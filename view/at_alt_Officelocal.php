        ...
        <section class="content">
			<?php
				$menu = array(
							...
							"N" => array("class" => "btn btn-warning btn-sm", "icone" => "fa fa-refresh", "id"=>"btn_AltOffice","label"=>"Alterar")
							);
 				extract($_GET);
 				$rs = new recordset();
 				$sql = "SELECT * FROM mq_office WHERE office_id = ".$officeid;
 				$rs->FreeSql($sql);
 				$rs->GeraDados();
							...
							<div class="box-body">
								...
								<div id="clientes" class="row">
									<div class="form-group col-xs-1">
										<label for="office_id">#ID:</label>
										<input type="text" DISABLED class="form-control" name="office_id" id="office_id" value="<?=$rs->fld("office_id");?>"/>
										
									</div>
									<div class="form-group col-md-4">
										<label for="office_desc">Office:</label>
											<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-opera"></i>
										</div>
										<input type="text"  class="form-control" name="office_desc" id="office_desc" value="<?=$rs->fld("office_desc");?>"/>
									</div>
									</div>
									<div class="form-group col-md-2">  
										...
										<input type="text"  class="form-control" name="office_versao" id="office_versao" value="<?=$rs->fld("office_versao");?>"/>
									</div>
									</div>
