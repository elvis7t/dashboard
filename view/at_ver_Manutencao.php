							...
							<div class="box-body">
								...
								<div id="clientes" class="row">
									<div class="form-group col-xs-1">
										...
										<input type="text" DISABLED class="form-control" name="pre_id" id="pre_id" value="<?=$rs->fld("man_id");?>"/>
								...
								<div class="row"> 
									...
									<div class="form-group col-md-2">  
										<label for="pre_contato">#Valor:</label> 
										<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-usd"></i>
										</div>  
										<input type="text" DISABLED class="form-control" id="pre_contato" name="pre_contato"  value="<?=$fn->formata_din($rs->fld("man_valor"));?>">
									</div>
									</div>
									<div class="form-group col-md-2">
									<label for="pre_email">#N&ordm;O S:</label>
										<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-tag"></i>
										</div>									
									  <input type="text" DISABLED class="form-control" id="pre_email" name="pre_email"  value="<?=$rs->fld("man_os");?>">
									...
									<div class="form-group col-md-2">
										...
										<input type="text" DISABLED class="form-control " id="pre_tel" name="pre_tel" value="<?=$fn->data_br($rs->fld("man_dataretorno"));?>">
									</div>
									</div>
									<div class="form-group col-md-2">
									...
									<div class="form-group col-md-5"> 
										...
										<label for="emp_cnpj">#Servi&ccedil;os Realizados: </label>
											<textarea DISABLED  class="form-control" id="part_obs" ><?=$rs->fld("man_desc");?></textarea>
										</div>
										
										<div class="form-group col-md-10">
										<label for="emp_cnpj">#Observa&ccedil;&otilde;es: </label>
											<textarea DISABLED  class="form-control" id="part_obs" ><?=$rs->fld("man_obs");?></textarea>
										</div>
								</div> 
