...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
			<h1>
						Ativos
				<small>Outras Ocorrencias</small>
			</h1>
				...
				<!-- general form elements -->
					...
					<div class="box box-primary"> 
						<div class="box-header with-border">
							<h3 class="box-title">Equipamentos em Outras Ocorrencias</h3><div class="box-tools pull-right">
						...
						<div class="box-body">
							<table id="equipamentos" class="table table-bordered table-striped">
								...
								<tbody id="eq_cad"> 
									<?php require_once("at_tbOutroslocais.php");?>     
								</tbody> 
