...
session_start();
$sess = "COM";
$pag = "at_ger_Comp.php";// Fazer o link brilhar quando a pag estiver ativa
							...
							<div class="box-body">
								...
								<div class="form-group col-md-3 "> 
									...
									<div class="form-group col-md-2">
										...
										<input type="text" DISABLED class="form-control" id="comp_valor" name="comp_valor"  value="<?=$fn->formata_din($rs->fld("comp_valor"));?>">
									</div>
									</div> 
									...
									<div class="row">
										...
										<label for="comp_desc">#Solicita&ccedil;&atilde;o: </label>
											<textarea  DISABLED class="form-control" id="comp_desc" name="comp_desc" ><?=$rs->fld("comp_desc");?></textarea>
										</div>
