	...
	<tr>
		...
		<td>
			<div class="button-group">
				<!--<a 	class="btn btn-xs btn-primary" data-toggle='tooltip' data-placement='bottom' title='Alterar ' a href="at_alt_Prelocal.php?token=<?=$_SESSION['token']?>&acao=N&preid=<?=$rs->fld('pre_id');?>"><i class="fa fa-pencil"></i></a>-->
				<a 	class="btn btn-md btn-warning"
						data-toggle='tooltip' 
						data-placement='bottom'     
						title='Detalhes'
						a href="at_ver_Prestadoralocal.php?token=<?=$_SESSION['token']?>&acao=N&preid=<?=$rs->fld('pre_id');?>"><i class="fa fa-search"></i> 
					</a>
