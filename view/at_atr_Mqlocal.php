					...
					<div class="box-header with-border">
						...
						<form role="form" id="atr_mq"> 
							...
							<div class="box-footer"> 
								...
								<!--<a 	class="btn btn-sm btn-danger" data-toggle='tooltip' data-placement='bottom' title='Manuten&ccedil;&atilde;o'  a href="at_man_Mq.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id;?>"><i class="fa fa-wrench"></i> Manuten&ccedil;&atilde;o</a>-->
								...
								<a 	class="btn btn-sm btn-info" data-toggle='tooltip' data-placement='bottom' title='Gerenciar'  a href="at_ger_Mqlocal.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id?>"><i class="fa fa-dashboard"></i> Gerenciar</a>
