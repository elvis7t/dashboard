...
?>   
	...
	<script src="<?=$hosted;?>/assets/js/maskinput.js"></script><!--Chama o java script para mascara para tel -->
    <script src="<?=$hosted;?>/assets/js/jmask.js"></script><!--Chama o java script para mascara para tel -->
     <!-- ChartJS 1.0.1-->
