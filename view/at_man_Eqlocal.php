        ...
        <section class="content">
			<?php
				$menu = array(
							...
							"N" => array("class" => "btn btn-success  btn-sm", "icone" => "fa fa-wrench", "id"=>"btn_Man","label"=>"Enviar")  
							);
 				extract($_GET);
 				$rs = new recordset();
							...
							<div class="box-body">
								...
								<div id="usuarios" class="row">	
									...
									<div class="form-group col-md-3">   
										...
										<input type="text" DISABLED class="form-control" name="" id="" value="<?echo $fn->data_hbr($rs->fld("eq_datacad"));?>"/>  
										</div>
									</div>
								   ...
								   <div class="box-header with-border"> 
									<div class="box-tools pull-right"> 
										 ...
										 <div class="form-group col-xs-3"> 
											<label for="sel_pres">Selecione uma Prestadora</label>
												<div class="input-group">
												<div class="input-group-addon">  
													<i class="glyphicon glyphicon-briefcase"></i>
													</div> 
											<select class="form-control select2" id="sel_pres" name="sel_pres">
												<option value="">Selecione:</option>     
												<?php
												$whr = "pre_id<>0";
												$rs->Seleciona("*","eq_prestadoras",$whr); //É o mesmo que SELECT campos FROM tabela WHERE condição
												while($rs->GeraDados()){ // enquanto gerar dados da pesquisa
												
												?>  
												
												<option value="<?=$rs->fld("pre_id");?>"><?=$rs->fld("pre_alias");?></option>
												<?php 
												} 
											?>   
											    </select>  
										...
										<label for="man_desc">Motivo</label> 
										<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-exclamation-triangle"></i>
										</div>
										<input type="text"  class="form-control" name="man_desc" id="man_desc" placeholder="Desc. do Motivo"/>  
									</div>
									</div>
								...
								<div id="consulta"></div>
								<div id="formerrosMan" class="clearfix" style="display:none;">  
