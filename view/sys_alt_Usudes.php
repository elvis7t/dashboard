...
?>
	...
	<!-- jQuery Knob -->
	<script src="<?=$hosted;?>/assets/plugins/knob/jquery.knob.js"></script>    
    <!--AdminLTE App -->
	...
	<script src="<?=$hosted;?>/js/action_usuarios.js"></script>  <!--Chama o java script para mascara -->
	<script src="<?=$hosted;?>/js/controle.js"></script>  <!--Chama o java script para mascara e CEP AUTOMATICO -->
	<!-- Validation --> 
	<!-- SELECT2 TO FORMS --> 
