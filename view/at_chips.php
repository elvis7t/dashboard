        ...
        <section class="content">
			...
			<div class="row">
				...
				<div class="box box-success"> 
					...
					<!-- form start -->
					<div class="box-body">
						<table id="chips" class="table table-bordered table-striped">
							<thead>
								  <tr>
										<th>C&oacute;d:</th>
										<th>Empresa</th> 
							...
							<tbody id="chip_cad"> 
								<?php require_once("at_tbChips.php");?>  
							</tbody> 
							 
						</table>  
					</div><!-- /.box-body --> 
					<div class="box-footer"> 
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Novo Equipamento' href="at_vis_chips.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Novo</a>
			</div>
