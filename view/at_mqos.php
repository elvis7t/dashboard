    ...
    <div class="content-wrapper">
        ...
        <section class="content">
			...
			<div class="row">
				...
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Novo' href="at_vis_Os.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Novo</a>
			</div>
