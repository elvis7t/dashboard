		...
		<tr>
			...
			<td>
				<div class="button-group">
					<a 	class="btn btn-xs btn-primary" data-toggle='tooltip' data-placement='bottom' title='Alterar' a href="at_alt_Eqtipo.php?token=<?=$_SESSION['token']?>&acao=N&tipoid=<?=$rs->fld('tipo_id');?>"><i class="fa fa-pencil"></i></a>
