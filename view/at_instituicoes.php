					...
					<div class="box box-success"> 
						...
						<div class="box-body"> 
							<table id="inst" class="table table-bordered table-striped">
								...
								<tbody id="inst_cad"> 
									<?php require_once("at_tbInstituicoes.php");?>   
								</tbody> 
								 
							</table> 
						</div><!-- /.box-body --> 
						<div class="box-footer">
							<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Nova Institui&ccedil;&atilde;o' href="at_vis_Instituicoes.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Nova</a>
						</div>								
					</div><!-- /.box -->				
				</div><!-- /.form -->
			</div><!-- /.row -->
