...
session_start();
$sess = "ATIVOLOCAL";
$pag = "at_outroslocais.php";// Fazer o link brilhar quando a pag estiver ativa
        ...
        <section class="content"> 
			<?php
				$menu = array(
							...
							"N" => array("class" => "btn btn-success  btn-sm", "icone" => "fa fa-recycle", "id"=>"btn_Outeq","label"=>"Descartar")  
							);
 				extract($_GET);
 				$rs = new recordset();
							...
							<div class="box-body">
								...
								<div id="usuarios" class="row">	
									...
									<div class="form-group col-md-3">   
										...
										<input type="text" DISABLED class="form-control" name="" id="" value="<?=$rs->fld("eq_datacad")?>"/>  
										</div>
									</div>
									...
									<!--<div class="form-group col-md-2">  
												<label for="eq_ativo">Ativo</label><br>  
												<input type="radio" class="minimal" value=1 <?=($rs->fld("eq_ativo")==1?"CHECKED":"");?> id="eq_ativo" name="eq_ativo"> Ativo<br>
												<input type="radio" class="minimal" value=0 <?=($rs->fld("eq_ativo")==0?"CHECKED":"");?> id="eq_ativo" name="eq_ativo"> Inativo<br>
											</div>-->
								...
								<div id="usuarios" class="row">
								   ...
								   <div id="usuarios" class="row">
										...
										<input type="text"  class="form-control" name="eq_descmotivo" id="eq_descmotivo" placeholder="Des. o motivo" >   
									</div>
									</div>									
								</div>  
								
								<div id="consulta"></div>
								<div id="formerrosOuteq" class="clearfix" style="display:none;">  
				...
				<div class="box box-success ">
					...
					<div class="box-body">
						<table id="empresas" class="table table-bordered table-striped">
							...
							<tbody id="Man_cad">  
							<?php require_once("at_tbManlocal.php");?>    	
							</tbody> 
