        ...
        <section class="content"> 
			<?php
				$menu = array(
							...
							"N" => array("class" => "btn btn-success  btn-sm", "icone" => "fa fa-recycle", "id"=>"btn_Descmq","label"=>"Descartar")  
							);
 				extract($_GET);
 				$rs = new recordset();
					...
					<div class="box-header with-border">
						...
						<form role="form" id="Descmq">
							...
							<div class="box-body">
								...
								<div id="consulta"></div>
								<div id="formerrosDescmq" class="clearfix" style="display:none;">  
