...
$sql ="SELECT * FROM at_departamentos a
		...
		WHERE  dp_empId=".$_SESSION['usu_empresa'];
		$rs->FreeSql($sql);
if($rs->linhas==0):
	...
	<tr>
		...
		<td>
			<div class="button-group">
				<a 	class="btn btn-sm btn-primary" data-toggle='tooltip' data-placement='bottom' title='Alterar Departamento' a href="at_alt_Dplocal.php?token=<?=$_SESSION['token']?>&acao=N&dpid=<?=$rs->fld('dp_id');?>"><i class="fa fa-pencil"></i></a>
