	...
	<tr>	
		...
		<td>   
			<div class="button-group"> 
				<a 	class="btn btn-xs btn-danger" data-toggle='tooltip' data-placement='bottom' title='detalhes'  a href="at_ver_Mqdescarte.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$rs->fld('mq_id');?>"><i class="fa fa-thumbs-down"></i></a> 				
			</div>  
		</td>  
