					...
					<div class="box-header with-border">
						...
						<form role="form" id="atr_eq"> 
										...
										<div class="box-tools pull-right"> 
										 ...
										 <div class="form-group col-md-3"> 
											...
											<select class="form-control select2" id="sol_mq" name="sol_mq">
												...
												while($rs->GeraDados()){ // enquanto gerar dados da pesquisa
												?>
												<option value="<?=$rs->fld("mq_id");?>"><?=$rs->fld("mq_nome");?></option>
												<?php 
												}  
											?>  
											    </select>  
							...
							<div class="box-footer"> 
								...
								<a 	class="btn btn-sm btn-danger" data-toggle='tooltip' data-placement='bottom' title='Manuten&ccedil;&atilde;o'  a href="at_man_Eqlocal.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$eqid;?>"><i class="fa fa-wrench"></i> Manuten&ccedil;&atilde;o</a>
								
								<a 	class="btn btn-sm btn-info" data-toggle='tooltip' data-placement='bottom' title='Gerenciar'  a href="at_ger_Eqlocal.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$eqid;?>"><i class="fa fa-dashboard"></i> Gerenciar</a>
