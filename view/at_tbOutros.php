...
WHERE eq_ativo = '0' AND eq_statusId = 7
	...
	<tr>	
		...
		<td>   
			<div class="button-group"> 
				<a 	class="btn btn-xs btn-info" data-toggle='tooltip' data-placement='bottom' title='Detalhes'  a href="at_ver_Outros.php?token=<?=$_SESSION['token']?>&acao=N&doacaoid=<?=$rs->fld('eq_id');?>"><i class="glyphicon glyphicon-question-sign"></i></a> 
			</div>  
		</td>  
