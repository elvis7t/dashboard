    ...
    <div class="content-wrapper">
        ...
        <section class="content">
			<?php
				...
				$man_valor      = $rs->fld("man_valor");
				$man_os         = $rs->fld("man_os");						 
							...
							<div class="box-body">
								...
								<div class="row"> 	
									...
									<?php
										...
										<input type="text" DISABLED class="form-control" name=" " id=" " value="<?=$status_desc?>"/>  
										</div>
									</div>
									<?php
										}   
									...
									<div class="form-group col-md-3">
										...
										<input type="text" DISABLED class="form-control" id=" " name=" "  value="<?=$fn->data_hbr($rs->fld("man_dataida"));?>">
									</div>
									</div>
									...
									<div class="form-group col-md-2">
										...
										<input type="text" DISABLED class="form-control " id="" name=" "  value="<?=$rs->fld("usu_nome");?>">
									</div>
									</div>
									...
									<label for="man_os">#N&ordm;O S:</label>
									  ...
									  <input type="text"  class="form-control" id="man_os" name="man_os"  value="<?=$man_os;?>">
									...
									<div class="form-group col-md-2">  
										...
										<?php 
											...
											<?php else: ?>
											<input type="text"  class="form-control" id="man_valor" name="man_valor"  value="<?=$man_valor;?>">
									...
									<div class="form-group col-md-5"> 
										...
										<input type="text" DISABLED class="form-control" id=" " name=" "  value="<?=$rs->fld("man_motivo");?>">
									</div> 
									</div>
