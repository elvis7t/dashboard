...
WHERE eq_ativo = '0' AND id_inst =".$instid." AND eq_empId=".$_SESSION['usu_empresa']."  
...
WHERE mq_ativo = '0' AND id_inst =".$instid." AND mq_empId=".$_SESSION['usu_empresa']."";  
$rs->FreeSql($sql);
	...
	<tr>		
		...
		<td>   
			<div class="button-group">  
				...
				<a 	class="btn btn-xs btn-danger" data-toggle='tooltip' data-placement='bottom' title='Detalhes'  a href="at_ver_Doacaolocal.php?token=<?=$_SESSION['token']?>&acao=N&doacaoid=<?=$rs->fld('eq_id');?>"><i class="fa fa-thumbs-down"></i></a> 
			</div>  
		</td> 		
	</tr>	
<?php }
