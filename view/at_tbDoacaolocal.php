	...
	<tr>		
		...
		<td>   
			<div class="button-group">  
				...
				<a 	class="btn btn-xs btn-danger" data-toggle='tooltip' data-placement='bottom' title='Detalhes'  a href="at_ver_Doacaolocal.php?token=<?=$_SESSION['token']?>&acao=N&doacaoid=<?=$rs->fld('eq_id');?>"><i class="fa fa-heart"></i></a> 
			</div>  
		</td> 		
	</tr>	
<?php }
