        ...
        <section class="content"> 
			<?php
				$menu = array(
							...
							"N" => array("class" => "btn btn-info  btn-sm", "icone" => "fa fa-recycle", "id"=>"btn_outmq","label"=>"Outras ocorrencias")  
							);
 				extract($_GET);
 				$rs = new recordset();
							...
							<div class="box-body">
								...
								<div id="usuarios" class="row">
								   ...
								   <div id="usuarios" class="row">
										...
										<input type="text"  class="form-control" name="mq_descmotivo" id="mq_descmotivo" placeholder="Des. o motivo">   
									</div>
									</div>									
								</div>  
								
								<div id="consulta"></div>
								<div id="formerrosOutmq" class="clearfix" style="display:none;">  
				...
				<div class="box box-success ">
					...
					<div class="box-body">
						<table id="empresas" class="table table-bordered table-striped">
							...
							<tbody id="Man_cad">  
							<?php require_once("at_tbManmqlocal.php");?>    	
							</tbody> 
