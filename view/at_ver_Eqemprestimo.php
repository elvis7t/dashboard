			...
			?>
			 <div class="row">
							...
							<div class="box-body">
								...
								<div id="clientes" class="row">
									...
									<div class="form-group col-md-3">
										...
										<input type="text" DISABLED class="form-control" id="pre_end" name="pre_end"  value="<?=$rs->fld("empre_eqdesc");?>">
									</div>
									</div>
				...
				<div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title">Historico de Solicitantes </h3><div class="box-tools pull-right">
		                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>   
						</div>
					</div><!-- /.box-header --> 
					<!-- form start -->
					<div class="box-body">
						<table id="emprestimo" class="table table-bordered table-striped">
							<thead>
								  <tr>
										<th>C&oacute;d:</th>
										<th>Empresa</th>  
							...
							<tbody id="empre_cad"> 
								<?php require_once("at_tbEqemphistorico.php");?>      
							</tbody> 
