							...
							<div class="box-body">
								...
								<div class="form-group  col-md-2">  
									...
									<div class="form-group col-md-3">
										...
										<input type="text" DISABLED class="form-control" id="pre_tel" name="pre_tel"  value="<?=$fn->data_hbr($man_dataida );?>">
									</div> 
									</div>
									<?php
									...
									<div class="form-group col-md-2">
										...
										<input type="text"  DISABLED class="form-control data_br" id="man_dataretorno" name="man_dataretorno" value="<?=$man_dataretorno?>">
									</div>
									</div> 
									 <?php
