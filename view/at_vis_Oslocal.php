...
session_start();
$sess = "ATIVOLOCAL"; 
$pag = "at_mqoslocal.php";// Fazer o link brilhar quando a pag estiver ativa
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Cadastro de Sistema Operacional</li>
			</ol>
        </section>
        <!-- Main content -->
			...
			<div class="row">
				...
				*/
				...
				<!-- general form elements -->
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Cadastro de Sistema Operacional</h3><div class="box-tools pull-right">
		                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>   
						</div>
						</div><!-- /.box-header -->
						<!-- form start -->
						<form id="cadOs" role="form">
							<div class="box-body">
								<div class="row">
									<div class="form-group col-md-5">
										...
										<input type="text" class="form-control" id="os_desc" name="os_desc"  placeholder="Desc. do Sistema Operacional">
									</div>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-3">
										...
										<input type="text" class="form-control" id="os_versao" name="os_versao"  placeholder="Desc. a Vers&atilde;o X">
									</div>
									</div>
								</div>
								
								<div id="formerrosCadOs" class="clearfix" style="display:none;"> 
							...
							<div class="box-footer">
								<button type="button" id="btn_cadOs" class="btn btn-primary" type="submit"><i class="fa fa-save"></i> Salvar</button>
							</div>
							<div id="mens"></div>
						</form>
					</div><!-- /.box -->
				...
				<div class="box box-success ">
					<div class="box-header with-border">
						<h3 class="box-title">Sistemas Cadastrados</h3><div class="box-tools pull-right">
					...
					<div class="box-body">
						<table id="fabricante" class="table table-bordered table-striped">
							...
							<tbody id="Os_cad"> 
								<?php require_once("at_tbOslocal.php");?>   
							</tbody>
