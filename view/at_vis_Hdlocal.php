...
session_start();
$sess = "ATIVOLOCAL";
$pag = "at_mqhdlocal.php";// Fazer o link brilhar quando a pag estiver ativa
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Cadastro de HD</li>
			</ol>
        </section>
        <!-- Main content -->
				...
				<!-- general form elements -->
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Cadastro de HD</h3><div class="box-tools pull-right">
		                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>   
						</div>
						</div><!-- /.box-header -->
						<!-- form start -->
						<form id="hd" role="form"> 
							<div class="box-body">
								<div class="row">
								
									<div class="form-group col-md-3">
										<label for="hd_tipo">Tipo</label> 
										<div class="input-group">
											<div class="input-group-addon">
												<i class="fa fa-hdd-o"></i> 
											</div>
										<input type="text" class="form-control" id="hd_tipo" name="hd_tipo"  placeholder="Desc. do Tipo">
									</div>
									</div>
									
									<div class="form-group col-md-3">
										<label for="hd_cap">Capacidade</label> 
										<div class="input-group">
											<div class="input-group-addon">
												<i class="fa fa-hdd-o"></i>
											</div>
										<input type="text" class="form-control" id="hd_cap" name="hd_cap"  placeholder="Desc. da Capacidade">
									</div>
									</div>
								</div>  
								
								<div id="formerrosHd" class="clearfix" style="display:none;">  
							...
							<div class="box-footer">  
								<button type="button" id="btn_cadHd"  class="btn btn-primary" type="submit"><i class="fa fa-save"></i> Salvar</button>
							</div>
							<div id="mens"></div>
						</form>
					</div><!-- /.box -->
				...
				<div class="box box-success"> 
					...
					<div class="box-body">
						<table id="MQmarca" class="table table-bordered table-striped">
							...
							<tbody id="cad_hd">
								<?php require_once("at_tbHdlocal.php");?>    
							</tbody> 
