			...
			<div class="row">
				...
				<div class="box box-success"> 
	 				<div class="box-header with-border">
						<h3 class="box-title">M&aacute;quinas na reserva</h3><div class="box-tools pull-right">
					...
					<div class="box-body">
						<table id="maquinas" class="table table-bordered table-striped">
							...
							<tbody id="mq_cad"> 
								<?php require_once("at_tbMaquinasreservalocal.php");?>     
							</tbody> 
							 
						</table>  
					</div><!-- /.box-body --> 
					<div class="box-footer"> 
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Nova M&aacute;quina' href="at_vis_Maquinaslocais.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Nova</a>
			</div>
