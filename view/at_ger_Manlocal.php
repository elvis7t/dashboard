								...
								<div class="row"> 	
									...
									<div class="form-group col-md-5"> 
										...
										<label for="man_desc">#Servi&ccedil;os Realizados: </label>
											<textarea   class="form-control" id="man_desc" name="man_desc" ><?=$rs->fld("man_desc");?></textarea>
										</div> 
										
										<div class="form-group col-md-10"> 
										<label for="man_obs">#Observa&ccedil;&otilde;es: </label>
											<textarea  class="form-control" id="man_obs" name="man_obs" ><?=$rs->fld("man_obs");?></textarea>
										</div>
								</div> 
