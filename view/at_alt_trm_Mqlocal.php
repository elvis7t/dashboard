...
session_start();
$sess = "ATIVOLOCAL";
$pag = "at_termo_utilizacaolocal.php";// Fazer o link brilhar quando a pag estiver ativa
						...
						<form role="form" id="cadTrm">
							<div class="box-body">
									...
									<div id="usuarios" class="row"> 
										...
										<?php
											$whr = "mq_usuId=".$usuid." AND mq_id=".$eq_id;
								...
								<div class="box-footer">
									...
									<button class="btn btn-primary" type="button" id="btn_altTrmMq"><i class="fa fa-refresh"></i> Alterar</button>
