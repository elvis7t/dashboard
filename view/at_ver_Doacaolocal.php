					...
					<div class="box box-primary">
						...
						<form role="form" id="Desceq">
							<div class="box-body">
								...
								<div id="usuarios" class="row">
									<div class="form-group col-md-3">   
										<label for="usu_nome">#Doado por:</label> 
											<div class="input-group">
												<div class="input-group-addon">  
									...
									<div class="form-group col-md-2">
										<label for="marc_nome">#Doado em:</label>
										<div class="input-group">
											<div class="input-group-addon">
												<i class="fa fa-calendar-check-o"></i>
											</div>
												<input type="text" DISABLED class="form-control" name="marc_nome" id="marc_nome" value="<?=$fn->data_br($rs->fld("eq_datadoa"));?>"/>
										</div>
									</div>
					...
					<div class="box box-success ">
						...
						<div class="box-body">
							<table id="empresas" class="table table-bordered table-striped">
								...
								<tbody id="Man_cad">  
									<?php require_once("at_tbMandoacaolocal.php");?>    	
								</tbody> 								 
							</table>
						</div><!-- /.box-body --> 									
					</div><!-- /.box -->  
