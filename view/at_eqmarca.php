				...
				<div class="box box-success"> 
					...
					<div class="box-body">
						<table id="marca" class="table table-bordered table-striped">
							...
							<tbody id="cad_marca">
								<?php require_once("at_tbMarca.php");?>    
							</tbody> 
							 
						</table>
					</div><!-- /.box-body --> 
					<div class="box-footer">
				<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Nova Marca' href="at_vis_Marca.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Nova</a>
			</div>
