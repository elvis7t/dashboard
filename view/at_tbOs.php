	...
	<tr>
		...
		<td>
			<div class="button-group">
				<a 	class="btn btn-xs btn-primary" data-toggle='tooltip' data-placement='bottom' title='Alterar' a href="at_alt_Os.php?token=<?=$_SESSION['token']?>&acao=N&osid=<?=$rs->fld('os_id');?>"><i class="fa fa-pencil"></i></a>
