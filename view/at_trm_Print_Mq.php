...
<body onload="window.print();">
		...
		<?php
 				...
 				$sql ="SELECT * FROM at_usu_termo_utilizacao A
						...
						JOIN mq_fabricante G     ON G.fab_id  =  A.trm_eqmarcId
						JOIN at_maquinas H       ON H.mq_id   =  A.trm_eqId
		...
		?>
							...
							<div class="box-body">
								...
								<title>Empresa:</title>
									...
									<img src="<?=$hosted."/".$rs->fld('emp_img_trm');?>">
								<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0>
									 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:26.5pt'>
									<td >								 
								<div class=WordSection1 style='margin:20pt;'> 
									...
									Arial'> Pelo presente termo de responsabilidade de entrega de 1 (um) <?=$rs->fld("tipo_desc");?>, 
									marca <?=$rs->fld("fab_nome");?>, modelo <?=$rs->fld("mq_modelo");?>, n&uacute;mero Serial: <?=$rs->fld("mq_tag");?>,
									...
									<img src="../images/img_trm_emp/niff_rodape.png" >
								...
								<div class=WordSection1 style='margin:20pt;'>
									...
									<p class=MsoNormal style='tab-stops:468.0pt'></p>
