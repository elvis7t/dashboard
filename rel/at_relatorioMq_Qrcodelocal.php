...
session_start();
$sess = "REL_LOCAL";
$pag = "at_relatorioMq_Qrcodelocal.php";
						...
						<div class="box-body">
							...
							<div class="row">
							 ...
							 <div class="row no-print">
								...
								<button class="btn btn-sm btn-primary" type="button" id="bt_relMqQrcode"><i class="fa fa-file-pdf-o"></i> Gerar Relat&oacute;rio</button>
...
<script src="<?=$hosted;?>/assets/plugins/jQuery/jQuery-2.1.4.min.js"></script>
   ...
   <!-- Slimscroll -->
    ...
    <script src="<?=$hosted;?>/js/action_ativoslocais.js"></script>
