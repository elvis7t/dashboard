...
$filtro ="";
	...
	$sql = "SELECT inst_alias, eq_id, emp_alias, tipo_desc, marc_nome, eq_modelo, eq_desc, status_desc, eq_datadoa, usu_nome
			...
			WHERE eq_ativo = '0' AND id_inst =".$sel_inst." 
			...
			WHERE mq_ativo = '0' AND id_inst =".$sel_inst." "; 
...
if(isset($di) AND $di<>""){
	...
	<tr>
		...
		<td>'.$func->data_br($rs_rel->fld("eq_datadoa")).'</td>
				...
				<div class="row">
				  <div class="col-xs-12">
					<h2 class="page-header">
						<i class="fa fa-globe"></i>'.$rs_rel->pegar("emp_nome","at_empresas","emp_id = '".$sel_inst."'").'
				...
				<div class="row">
					<div class="col-xs-12 table-responsive">
						<table class="table table-striped">
							<thead>
								  <tr><th colspan=7><h2>Relat&oacute;rio de Doa&ccedil;&otilde;es ao '.$rs_rel->pegar("inst_alias","at_instituicoes","inst_id = '".$_SESSION['usu_empresa']."'").' </h2></th></tr>
									  <tr> 
