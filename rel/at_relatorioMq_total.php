						...
						<form role="form" id="rels">
							<div class="box-body">
								...
								<div class="row">
										...
										<input type="hidden" value="at_maquinas" name="rel_tbl_total" id="rel_tbl_total">		
						...
						<div class="box-body">
							...
							<div class="row">
							 ...
							 <div class="row no-print">
								...
								<button class="btn btn-sm btn-primary" type="button" id="bt_relMq_total"><i class="fa fa-file-pdf-o"></i> Gerar Relat&oacute;rio</button>
