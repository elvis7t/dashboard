...
session_start();
$sess = "REL";
$pag = "at_relatorio_telefonia.php";
							...
							<div class="row">
								<div class="col-xs-12 table-responsive">
								  <table class="table table-striped">
									<thead>
									  <tr><th colspan=7><h2>Relat&oacute;rio de Telefonia</h2></th></tr>
									  <tr> 
							 ...
							 <div class="row no-print">
								...
								<button class="btn btn-sm btn-primary" type="button" id="bt_reltel"><i class="fa fa-file-pdf-o"></i> Gerar Relat&oacute;rio</button>
