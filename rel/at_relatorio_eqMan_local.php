...
session_start();
$sess = "REL_LOCAL";
$pag = "at_relatorio_eqMan_local.php"; 
					...
					<div class="box box-primary">
						...
						<form role="form" id="rels">
							...
							<div class="box-footer">
								<button class="btn btn-sm btn-primary" type="button" id="bt_relEqman_empresa"><i class="fa fa-pie-chart"></i> Gerar Relat&oacute;rio</button>
						...
						<form role="form" id="rels">
							<div class="box-body">
								...
								<div class="row">
										...
										<input type="hidden" value="eq_manutencao" name="rel_tbl" id="rel_tbl">		
										<input type="hidden" value="<?=$_SESSION['usu_empresa'];?>" name="sel_emp" id="sel_emp">		
									</div>	 
...
<script src="<?=$hosted;?>/assets/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    ...
    <script src="<?=$hosted;?>/js/action_ativos.js"></script>
