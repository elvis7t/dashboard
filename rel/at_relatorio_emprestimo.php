...
session_start();
$sess = "REL";
$pag = "at_relatorio_emprestimo.php";
						...
						<form role="form" id="rels">
							<div class="box-body">
								...
								<div class="row">
										...
										<input type="hidden" value="eq_emprestimo" name="rel_tbl" id="rel_tbl">		
							...
							<div class="box-footer">
								<button class="btn btn-sm btn-primary" type="button" id="bt_relEmprestimeq"><i class="fa fa-pie-chart"></i> Gerar Relat&oacute;rio</button>
