...
session_start();
$sess = "REL";
$pag = "at_relatorio_solicitacao_usuario.php";
						...
						<form role="form" id="rels">
							<div class="box-body">
								...
								<div class="box-footer">
									<button class="btn btn-sm btn-primary" type="button" id="bt_relSolicitacaoequsu"><i class="fa fa-pie-chart"></i> Gerar Relat&oacute;rio</button>
